...
class Identity_Model_Mod_bilinear(AbstractModel.AbstractModel):

    def __init__(self, no_senses, vocab_size, dropout_bilinear_forms, dropout_matrix):
        super(Identity_Model_Mod_bilinear, self).__init__()
    ...
    def create_architecture(self, batch_size, lookup):
        ...
        self._specialized_modifier = super(Identity_Model_Mod_bilinear,
